...
const Navbar = () => {
  return (
    <nav
      className="flex w-full items-center justify-between border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        <div className="size-7 rounded-full">
            <img src="src/assets/logo.png" alt="logo" />
        </div>
        <h1 className="text-base font-bold md:text-xl">HCare</h1>
      </div>
      {/* <button
