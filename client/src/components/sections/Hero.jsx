    ...
    <div className="relative mx-auto my-1 flex max-w-7xl flex-col " name="hero">
      ...
      <div className="relative px-4 py-10 md:py-20  text-center items-center justify-center">
        ...
        <motion.div
          ...
          <Link className="hover:cursor-pointer relative w-60 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200"
            to="predictorform" smooth={true} duration={1500}>
            Explore Now
          </Link>
